"""
Individual agents for the multi-agent document validation system.
"""
import logging
import json
...
from app.schemas.validation import AgentResponse, ValidationIssue
...
class BaseAgent(ABC):
    ...
    def __init__(self, name: str):
        ...
        self.model = ChatVertexAI(
            model=settings.VERTEX_AI_MODEL_TEXT,
    ...
    async def analyze(
        ...
        try:
            ...
            analysis_prompt = self.get_analysis_prompt(
                ocr_text, document_type, extracted_data, previous_findings
            )
...
with other documents from the same person.
